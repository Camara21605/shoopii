  ...
  return (
    <>
      ...
      <FormCard title="Adresse physique" icon="fa-location-dot" subtitle="Localisation de votre boutique ou point de retrait">
        ...
        <div className={s.fg}><div className={s.fl}>Repère / Indication</div><div className={s.fw}><i className={`fas fa-sign-hanging ${s.fi}`} /><input className={s.fin} defaultValue="Bâtiment rouge à côté de la pharmacie centrale, panneau Shoneya visible" onChange={onDirty} /></div><div className={s.hint}><i className="fas fa-circle-info" /> Aide les livreurs et clients à vous trouver facilement</div></div>
