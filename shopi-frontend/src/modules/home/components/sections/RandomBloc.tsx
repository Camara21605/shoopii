...
/* ─────────────────────────────────────────────────────────────
 * BLOC PRODUITS (détail — catalogue courant, pas la vente en gros)
 * C'est le bloc qui manquait : sans lui, un produit publié en visibilité
 * PUBLIC mais pas marqué "vente en gros" n'apparaissait nulle part sur
 * la home (seul /explorer le montrait) — RandomBloc ne proposait que
 * "produits-gros" comme bloc produit.
 ───────────────────────────────────────────────────────────── */
