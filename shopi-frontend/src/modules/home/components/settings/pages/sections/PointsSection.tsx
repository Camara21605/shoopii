  ...
  return (
    <div style={{
      ...
      <div style={{ position:'relative', zIndex:1 }}>
        <div style={{ fontSize:10, fontWeight:800, textTransform:'uppercase', letterSpacing:'1.2px', color:'var(--t2)', marginBottom:8 }}>Mes Shopi Points</div>
        <div style={{ fontFamily:'var(--fd)', fontSize:48, fontWeight:800, color:'var(--t1)', lineHeight:1, marginBottom:4 }}>
          {pts.points.toLocaleString('fr-FR')} <span style={{ fontSize:18, fontWeight:400, color:'var(--t2)' }}>pts</span>
        </div>
