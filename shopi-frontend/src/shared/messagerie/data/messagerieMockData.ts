...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    ...
    messages:[
      ...
      { id:'m3', from:'u1', type:'product', text:'Voici le produit à livrer :', time:'09:07', read:true,
        product:{ productId:'mock-product-1', summary:'iPhone 15 Pro 256GB · 12 500 000 GNF' } },
      { id:'m4', from:'u1', type:'order', text:'Commande associée :', time:'09:08', read:true,
        order:{ orderId:'mock-order-1', summary:'Commande SH-2025-0901 · En livraison · 12 500 000 GNF' } },
