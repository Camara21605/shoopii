...
import {
  OSM_TILE, OVERVIEW_BASE_LIGHT, OVERVIEW_BASE_DARK, OVERVIEW_ROADS, DARK_TILE_CLASS,
} from '../utils/geoUtils';
...
export default function BaseTiles({ dark = false }: { dark?: boolean }) {
  return (
    <>
      ...
      <TileLayer key={`overview-${dark}`} {...(dark ? OVERVIEW_BASE_DARK : OVERVIEW_BASE_LIGHT)} zIndex={1} />
      <TileLayer key="overview-roads" {...OVERVIEW_ROADS} zIndex={2} />
